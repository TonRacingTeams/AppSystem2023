                ...
                public void onClick(View v) {
                    ...
                    try{
                        ...
                        try{
                           ...
                           // double vTaxs= (double) (Math.ceil(vTax/100.0))*100; ບໍໃຫ້ປັດ
                        ...
                        if (PRESREAD.isEmpty()) {
                            ...
                            try {
                                ...
                                if(isconnected){
                                    String version = "numpapavte05052023.apk";
...
//*/
                                    ...
                                    databaseAccess.open();
                                    databaseAccess.addBT(PRESDATE, Usr_id1, android, khetID, AREACODE,billno,ACCOUNT);
